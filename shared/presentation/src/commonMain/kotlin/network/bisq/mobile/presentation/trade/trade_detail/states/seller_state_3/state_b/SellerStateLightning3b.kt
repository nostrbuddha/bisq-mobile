...
fun SellerStateLightning3b(
    ...
    val isBtcConfirmedLoading by presenter.isBtcConfirmedLoading.collectAsState()

    if (buyerHasConfirmedBitcoinReceipt) {
        SellerStateLightning3bPaymentConfirmed(presenter, isBtcConfirmedLoading)
    } else {
        SellerStateLightning3bWaitingForPayment(presenter, isBtcConfirmedLoading)
    }
}
    ...
    Column {
        ...
        Column {
            ...
            BisqButton(
                ...
                disabled = isBtcConfirmedLoading,
            )
        }
    }
}
...
private fun SellerStateLightning3bPaymentConfirmed(
    ...
    Column {
        ...
        BisqButton(
            ...
            isLoading = isBtcConfirmedLoading,
        )
    }
}
