...
fun UserProfileSettingsScreen() {
    ...
    BisqScrollScaffold(
        ...
        SettingsTextField(label = "user.userProfile.nymId".i18n(), value = botId, editable = false)
        ...
        SettingsTextField(label = "user.userProfile.profileId".i18n(), value = profileId, editable = false)
